...
const reviewCommentData = require("../../data/books/bookReviewsComments");
...
router.get("/:reviewId", async (req, res) => {
    if (req.session.user) {
      try {
        ...
        res.render("site/catalog/bookReviewComment", { review: review });
      } catch (e) {
...
router.post("/:reviewId", async (req, res) => {
    if (req.session.user) {
        ...
        try {
            ...
            res.render("site/catalog/bookReviewComment", { review: review, posted: true });
        } catch (e) {
            res.render("site/catalog/bookReviewComment", { review: review, error: e});
        }
    } else {
      res.redirect("/");
    }
